...
alter table t_order_book_detail add column order_send_status varchar(5) default null comment '投产下发状态';
...
alter table t_order_book_detail add column sale_type_id varchar(20) default null comment '销售分类id';
alter table t_order_book_detail add column sale_type varchar(20) default null comment '销售分类';
...
alter table t_order_book_detail add column place_order_type varchar(10) default null comment '下单类型';
...
alter table t_push_records modify column response_message text default null comment '返回消息，推送结果的返回消息或错误信息';