...
update t_order_book_detail set hidden = '1', column_width = '80',sort_order = '9', del_flag = '0' where id = 'orderBook42';
update t_order_book_detail set hidden = '1', column_width = '100',sort_order = '14', del_flag = '0' where id = '1742859895962791938';