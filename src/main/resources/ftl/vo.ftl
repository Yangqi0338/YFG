 ...
 * 不得使用、复制、修改或发布本软件.
 *****************************************************************************/
package ${javapackage}.${project}.vo;
<#if hasBigDecimal >
...
/**
 * 类描述：${title}Vo 实体类
 * @address ${javapackage}.${project}.vo.${className}Vo
 * @author ${author}
 * @email ${email}
 * @date 创建时间：${.now}
 * @version 1.0
 */
@Data
@ApiModel("${title} ${className}Vo")
public class ${className}Vo extends BaseDataEntity<String> {
