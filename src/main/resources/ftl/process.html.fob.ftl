...
<#if sizeDataList??>
    <#if sizeList?size gt 5>
        <table class="table_border size_table_border mt" style="page-break-before: always; ">
            ...
            <tr class="size_tr gb">
                ...
                <#if sizeList??>
                    <#list sizeList as size>
                        <th colspan="${sizeColspan}" class="size_${sizeClass[(size_index)*sizeColspan+2]} sizeWidth" style="border-left: 1.34px solid #000000; border-right: 1.34px solid #000000">
                            ${size}
                        </th>
                    </#list>
                </#if>
            ...
            <tr>
                <#list sizeList as size>
                    <td class="sizeItemWidth size_${sizeClass[(size_index+1)*sizeColspan-sizeColspan+2]}"  style="text-align: center;border-left: 1.34px solid #000000;<#if washSkippingFlag><#else>border-right: 1.34px solid #000000;</#if>">成衣<br>尺寸</td>
                    <#if washSkippingFlag>
                        <td class="sizeItemWidth size_${sizeClass[(size_index+1)*sizeColspan-sizeColspan+1+2]}" style="text-align: center;border-right: 1.34px solid #000000;">洗后<br>尺寸</td>
                    </#if>
                </#list>
            </tr>
            </thead>
    ...
    <#else>
        <table class="table_border mt size_table" style="page-break-before: always; ">
            ...
            <tr>
                <#list sizeList as size>
                    <td class="sizeItemWidth ${sizeClass[(size_index+1)*sizeColspan-sizeColspan+2]}" style="text-align: center;border-left: 1.34px solid #000000; <#if washSkippingFlag>padding: 0 10px;<#else>padding: 0 30px;border-right: 1.34px solid #000000;</#if>">成衣尺寸</td>
                    <#if washSkippingFlag>
                        <td class="sizeItemWidth ${sizeClass[(size_index+1)*sizeColspan-sizeColspan+1+2]}" style="text-align: center; padding: 0 10px;border-right: 1.34px solid #000000">洗后尺寸</td>
                    </#if>
                </#list>
            </tr>
            </thead>
