...
/**
 * 类描述：产前样-任务Vo 实体类
 * @address com.base.sbc.module.sample.vo.PreProductionSampleTaskFobVo
 * @author your name
 * @email your email
 ...
 */
@Data
@ApiModel("产前样-任务 PreProductionSampleTaskFobVo")
public class PreProductionSampleTaskFobVo extends BaseDataEntity<String> {
