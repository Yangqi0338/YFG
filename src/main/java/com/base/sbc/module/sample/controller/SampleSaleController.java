...
@Validated
public class SampleSaleController extends BaseController {
    ...
    @PostMapping("/save")
    public ApiResult save(@RequestBody SampleSaleSaveDto dto) {
        return updateSuccess(sampleSaleService.save(dto));
    }
