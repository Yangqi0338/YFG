 ...
 */
@Service
public class FabricDetailedInformationBaseServiceImpl extends BaseServiceImpl<FabricDetailedInformationMapper, FabricDetailedInformation> implements FabricDetailedInformationService {
    @Autowired
