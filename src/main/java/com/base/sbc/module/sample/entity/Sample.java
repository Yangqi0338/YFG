...
public class Sample extends BaseDataEntity<String> {
    ...
    /** 样衣设计ID，对应 t_sample_design.id 主键ID */
    @ApiModelProperty(value = "样衣设计ID，对应 t_sample_design.id 主键ID")
    private String sampleDesignId;
    /** 款式名称，对应 t_sample_design.style_name 款式名称 */
    @ApiModelProperty(value = "款式名称，对应 t_sample_design.style_name 款式名称")
    private String styleName;
    /** 设计款号，对应 t_sample_design.design_no 设计款号 */
    @ApiModelProperty(value = "设计款号，对应 t_sample_design.design_no 设计款号")
