 ...
 */
@Service
public class PackBusinessOpinionServiceImpl extends AbstractPackBaseServiceImpl<PackBusinessOpinionMapper, PackBusinessOpinion> implements PackBusinessOpinionService {
