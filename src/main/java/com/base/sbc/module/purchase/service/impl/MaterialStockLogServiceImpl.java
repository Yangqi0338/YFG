...
/** 
 * 类描述：物料库存-明细 service类
 * @address com.base.sbc.module.purchase.service.MaterialStockLogService
 * @author tzy
 ...
 */
@Service
public class MaterialStockLogServiceImpl extends BaseServiceImpl<MaterialStockLogMapper, MaterialStockLog> implements MaterialStockLogService {
