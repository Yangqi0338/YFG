...
/** 
 * 类描述：出库单-明细 service类
 * @address com.base.sbc.module.purchase.service.OutboundOrderDetailService
 * @author tzy
 ...
 */
@Service
public class OutboundOrderDetailServiceImpl extends BaseServiceImpl<OutboundOrderDetailMapper, OutboundOrderDetail> implements OutboundOrderDetailService {
