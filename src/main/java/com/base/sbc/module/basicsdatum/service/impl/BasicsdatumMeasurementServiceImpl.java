    ...
    public Boolean importExcel(MultipartFile file) throws Exception {
        ...
        for (BasicsdatumMeasurementExcelDto basicsdatumMeasurementExcelDto : list) {
            ...
            if (StringUtils.isNotEmpty(basicsdatumMeasurementExcelDto.getImage())) {
                ...
                /*上传图*/
                AttachmentVo attachmentVo = uploadFileService.uploadToMinio(minioUtils.convertFileToMultipartFile(file1), "/System/Config/Measurement/" + basicsdatumMeasurementExcelDto.getCode() + ".jpg");
