...
/**
 * 类描述：基础资料-基础工艺 实体类
 * @address com.base.sbc.module.basicsdatum.entity.BasicsdatumBasicsTechnics
 * @author mengfanjiang
...
@TableName("t_basicsdatum_basics_technics")
@ApiModel("基础资料-基础工艺 BasicsdatumBasicsTechnics")
public class BasicsdatumBasicsTechnics extends BaseDataEntity<String> {
