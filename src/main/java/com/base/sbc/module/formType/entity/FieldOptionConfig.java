 ...
 * @author mengfanjiang
 * @email XX.com
 * @date 创建时间：2023-9-4 17:02:46
 * @version 1.0
 */
@Data
@EqualsAndHashCode(callSuper = true)
@TableName("t_field_option_config")
@ApiModel("字段选项配置表 FieldOptionConfig")
public class FieldOptionConfig extends BaseDataEntity<String> {
