...
/**
 * 类描述：下单最晚投产日期管理QueryDto 实体类
 * @address com.base.sbc.module.style.dto.LatestCommissioningDateQueryDto
 * @author your name
 * @email your email
 ...
 */
@Data
public class LatestCommissioningDateQueryDto extends Page {
