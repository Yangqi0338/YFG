...
/**
 * 类描述：下单最晚投产日期管理 实体类
 * @address com.base.sbc.module.style.entity.LatestCommissioningDate
 * @author your name
 * @email your email
...
@TableName("t_latest_commissioning_date")
@ApiModel("下单最晚投产日期管理 LatestCommissioningDate")
public class LatestCommissioningDate extends BaseDataEntity<String> {
