 ...
 */
public interface ThemePlanningMaterialService extends BaseService<ThemePlanningMaterial> {
...
// 自定义方法区 不替换的区域【other_start】
     ...
     * @return
     */
    List<ThemePlanningMaterialVO> getByThemePlanningId(String themePlanningId);

    /**
     * 保存
     *
     * @param themePlanningSaveDTO
     */
    void save(List<ThemePlanningMaterialSaveDTO> themePlanningMaterialSaves, String themePlanningId);
