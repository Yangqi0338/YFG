 ...
 */
@Service
public class PlanningDemandProportionDataBaseServiceImpl extends BaseServiceImpl<PlanningDemandProportionDataMapper, PlanningDemandProportionData> implements PlanningDemandProportionDataService {
    @Autowired
