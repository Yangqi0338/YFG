...
public class SampleBoardExcel {
    ...
    @Excel(name = "设计收到时间" , exportFormat = "yyyy年MM月dd日 HH:mm:ss",type = 1)
    ...
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @Excel(name = "设计确认齐套时间",exportFormat = "yyyy年MM月dd日 HH:mm:ss",type = 1)
    private Date technicianKittingDate;

    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @ApiModelProperty(value = "纸样需求完成日期")
    @Excel(name = "纸样需求完成日期",exportFormat = "yyyy年MM月dd日 HH:mm:ss",type = 1)
    private Date patternReqDate;

    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @ApiModelProperty(value = "样衣需求完成日期")
    @Excel(name = "样衣需求完成日期",exportFormat = "yyyy年MM月dd日 HH:mm:ss",type = 1)
    private Date demandFinishDate;


    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @ApiModelProperty(value = "技术收到日期")
    @Excel(name = "技术收到日期",exportFormat = "yyyy年MM月dd日 HH:mm:ss",type = 1)
    private Date jssdrq;
    ...
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @Excel(name = "版房主管下发时间",exportFormat = "yyyy年MM月dd日 HH:mm:ss",type = 1)
    ...
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @Excel(name = "版师接收时间",exportFormat = "yyyy年MM月dd日 HH:mm:ss",type = 1)
    private Date bsjssj;
    ...
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @Excel(name = "纸样完成时间",exportFormat = "yyyy年MM月dd日 HH:mm:ss",type = 1)
    private Date zywcsj;
    ...
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @Excel(name = "裁剪开始时间",exportFormat = "yyyy年MM月dd日 HH:mm:ss",type = 1)
    private Date cjkssj;

    @ApiModelProperty(value = "裁剪完成时间")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @Excel(name = "裁剪完成时间",exportFormat = "yyyy年MM月dd日 HH:mm:ss",type = 1)
    private Date cjwcsj;
    ...
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @Excel(name = "车缝开始时间",exportFormat = "yyyy年MM月dd日 HH:mm:ss",type = 1)
    private Date cfkssj;


    @ApiModelProperty(value = "车缝完成时间")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @Excel(name = "车缝完成时间",exportFormat = "yyyy年MM月dd日 HH:mm:ss",type = 1)
    private Date cfwcsj;


    @ApiModelProperty(value = "样衣完成时间")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @Excel(name = "样衣完成时间",exportFormat = "yyyy年MM月dd日 HH:mm:ss",type = 1)
    private Date yywcsj;
    ...
    @Excel(name = "创建指令时间",exportFormat = "yyyy年MM月dd日 HH:mm:ss",type = 1)
    ...
    @Excel(name = "下发给样衣组长时间",exportFormat = "yyyy年MM月dd日 HH:mm:ss",type = 1)
    ...
    @Excel(name = "放码时间",exportFormat = "yyyy年MM月dd日 HH:mm:ss",type = 1)
