 ...
 */
@Service
public class ProcessProcessSchemeBaseServiceImpl extends BaseServiceImpl<ProcessProcessSchemeMapper, ProcessProcessScheme> implements ProcessProcessSchemeService {
...
/** 自定义方法区 不替换的区域【other_start】 **/
    ...
    public Boolean addRevampProcessProcessScheme(AddRevampProcessProcessSchemeDto addRevampProcessProcessSchemeDto) {
        ...
        if (StringUtils.isEmpty(addRevampProcessProcessSchemeDto.getId())) {
            ...
            queryWrapper.eq("scheme_code", addRevampProcessProcessSchemeDto.getSchemeCode());
            List<ProcessProcessScheme> list = baseMapper.selectList(queryWrapper);
