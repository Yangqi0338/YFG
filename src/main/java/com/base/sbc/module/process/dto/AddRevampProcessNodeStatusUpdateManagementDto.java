...
import lombok.Data;
/**
 * 类描述：新增修改流程配置-节点状态修改字段 dto类
 * @address com.base.sbc.module.process.dto.ProcessNodeStatusUpdateManagement
 * @author mengfanjiang
...
public class AddRevampProcessNodeStatusUpdateManagementDto  {
