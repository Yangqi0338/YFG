...
//    @Excel(name = "计控确认成本时间", format = "yyyy-MM-dd HH:mm:ss")
    ...
    @Excel(name = "样衣图片", type = 2, imageType = 2)
    ...
    @Excel(name = "是否上会",replace = {"是_1","否_0"})
    ...
    @Excel(name = "材料成本", numFormat = "#.##",type = 10)
    private BigDecimal materialCost;
    /**
     * 包装费
     */
    @ApiModelProperty(value = "包装费")
    @Excel(name = "包装费", numFormat = "#.##",type = 10)
    private BigDecimal packagingFee;
    /**
     * 检测费
     */
    @ApiModelProperty(value = "检测费")
    @Excel(name = "检测费", numFormat = "#.##",type = 10)
    private BigDecimal testingFee;
    /**
     * 车缝加工费
     */
    @ApiModelProperty(value = "车缝加工费")
    @Excel(name = "车缝加工费", numFormat = "#.##",type = 10)
