 ...
 */
@Service
public class PricingProcessCostsBaseServiceImpl extends BaseServiceImpl<PricingProcessCostsMapper, PricingProcessCosts> implements PricingProcessCostsService {
    @Autowired
