...
public class SaasUploadController extends BaseController {
    ...
    //图片压缩起始值 M
    @Value("${upload.img.compress:3}")
    private Integer uploadImgCompress;
...
//        return filesUtils.uploadBigData(file, FilesUtils.PRODUCT, request);
    ...
    public AttachmentVo uploadFile(@RequestPart(value = "file", required = false) MultipartFile file,  UploadFileType type, String code, String isCompact) throws Throwable {
