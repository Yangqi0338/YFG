...
import com.base.sbc.pdm.entity.PlanningCategoryItemMaterial;
import com.base.sbc.pdm.dao.PlanningCategoryItemMaterialDao;

/** 
 * 类描述：企划-坑位关联的素材库表 service类
 * @address com.base.sbc.pdm.service.PlanningCategoryItemMaterialService
 * @author lxl
