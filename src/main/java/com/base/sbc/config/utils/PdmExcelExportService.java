...
public class PdmExcelExportService  extends PdmBaseExportService {
    ...
    private int createHeaderRow(ExportParams title, Sheet sheet, Workbook workbook, int index,
        ...
        for (int i = 0, exportFieldTitleSize = excelParams.size(); i < exportFieldTitleSize; i++) {
            ...
            if (org.apache.commons.lang3.StringUtils.isBlank(entity.getGroupName()) || i == 0 || !entity.getGroupName().equals(excelParams.get(i - 1).getGroupName())) {
                if (groupCellLength > 1) {
                    sheet.addMergedRegion(new CellRangeAddress(index, index, cellIndex - groupCellLength, cellIndex - 1));
                }
                groupCellLength = 0;
            }
            if (org.apache.commons.lang3.StringUtils.isNotBlank(entity.getGroupName())) {
                ...
                groupCellLength++;
            } else if (org.apache.commons.lang3.StringUtils.isNotBlank(entity.getName())) {
            ...
            if (entity.getList() != null) {
                ...
                if (org.apache.commons.lang3.StringUtils.isNotBlank(entity.getName()) && sTitel.size() > 1) {
                ...
                cellIndex--;
            } else if (rows > 1 && org.apache.commons.lang3.StringUtils.isBlank(entity.getGroupName())) {
