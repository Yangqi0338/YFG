...
public abstract class PdmBaseExportService extends ExportCommonService {
    ...
    public void createImageCell(Cell cell, double height,
        ...
        if (type.equals(ExcelType.HSSF)) {
            ...
            anchor = new HSSFClientAnchor(StyleUtil.getCoordinate(0), -StyleUtil.getCoordinate(0), -StyleUtil.getCoordinate(0), StyleUtil.getCoordinate(0), (short) cell.getColumnIndex(), cell.getRow().getRowNum(), (short) (cell.getColumnIndex()+1),
